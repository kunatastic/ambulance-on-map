...
<body>
    ...
    <div id="mainwrapper">
			...
			<form method="post" class="myform">
				...
				<!-- RegNo-->
				<input type="text" placeholder="Your Employee ID" name="regno" id="regno" class="inputvalues" autocomplete="off" required/ ><br/>
				<br/>
				...
				<!-- Email-->
				<input type="text" placeholder="Email" name="email" id="email" class="inputvalues" autocomplete="off" required/><br/>
				<br/>
				...
				<!-- con pass-->
				<input type="password" placeholder="Confirm Password" name="cpass" id="cpass" class="inputvalues" autocomplete="off" required/>
                <hr>
			...
			<?php
				if (isset($_POST['submit_btn'])){
                    ...
                    if ($cpass==$pass)
                    {
						$Queryr = "select * from signup where eid='$eid'";
						$duplicater=mysqli_query($con,$Queryr);

						if (!$duplicater || mysqli_num_rows($duplicater)>0){//check for duplicate registration
							echo '<script type="text/javascript">alert("Account already exists...! Search DB.")</script>';
						}else{
							$query="insert into signup values('$name','$eid','$phoneno','$email','$pass');";
