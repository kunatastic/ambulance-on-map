						...
						<div class="container">
							<div class="row text-center">
                                ...
                                <div class="testimonial-content">
										...
										<a href="newEmp.php" class="content-link">Add one</a>
										<br>
										<p id="redd"></p>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
									<div class="testimonial-content">
										...
										<h2>Add new hospitals</h2>
										<p>Ut ac odio scelerisque ante ornare commodo. Sed faucibus dui libero, in tincidunt purus pretium quis. </p>
										<a href="addhosp.php" class="content-link">Add one</a>
										<br>
										<p id="redd"></p>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
									<div class="testimonial-content">
										...
										<p>Ut ac odio scelerisque ante ornare commodo. Sed faucibus dui libero, in tincidunt purus pretium quis.</p>
										<a href="empdetails.php" class="content-link">details</a>
										<br>
										<p id="dets"></p>
									</div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
									<div class="testimonial-content">
										...
										<h2>Feedback</h2>
										<p>Ut ac odio scelerisque ante ornare commodo. Sed faucibus dui libero, in tincidunt purus pretium quis.</p>
										<a href="feedback.php" class="content-link">read it</a>
										<br>
										<p id="redd"></p>
									</div>
								</div>
